switch (KP_liberation_preset_blufor) do {
	...
	case 28: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\tft8.sqf";};
...
switch (KP_liberation_preset_opfor) do {
	...
	case 18: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Talon_Aegis.sqf";};
...
// Detect type of Mother Goose 1 and support vehicles
{
    _x params ["_class"];
    switch (true) do {
