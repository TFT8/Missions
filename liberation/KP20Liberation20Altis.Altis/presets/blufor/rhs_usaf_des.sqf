...
KP_liberation_little_bird_classname = "vvar_mh6m";                  // These are the little birds which spawn on the Freedom or at Chimera base.
...
light_vehicles = [
    ...
    ["rhsusf_M1240a1_usarmy_d",120,0,60],                                 // M1220
    ["rhsusf_M1240a1_m2_usarmy_d",120,0,60],                                 // M1220
    ["rhsusf_M1240a1_m2crows_usarmy_d",120,0,60],                                 // M1220
    ["rhsusf_M1240a1_m240_usarmy_d",120,0,60],                                 // M1220
    ["rhsusf_M1240a1_mk19_usarmy_d",120,0,60],                                 // M1220
    ["rhsusf_M1240a1_mk19crwos_usarmy_d",120,0,60],                                 // M1220
...
air_vehicles = [
    ...
    ["Ka50_base_01",400,400,200],                                     // AH-64D (Multi-Role)
    ["vvar_mi17_CAS",250,0,150],                                         // UH-60M (Unarmed)
    ["vvar_mi17_transport",250,0,150],                                         // UH-60M (Unarmed)
    ["RHS_UH60M2_d",250,0,150],                                         // UH-60M (Unarmed)
    ["RHS_UH60M_d",250,80,150],                                         // UH-60M
    ["RHS_UH60M_MEV2_d",300,0,150],                                     // UH-60M MEV2
    ["B_MH60L_gray_F",250,80,150],                                         // UH-60M
    ["hind_vvar",250,80,150],                                         // UH-60M
    ...
    ["FIR_F18C_RAAF",1250,1250,450],                                    // F/A-18A Hornet
    ["FIR_F16D_Polish_CFT",1250,1250,450],                                    // F/A-18A Hornet
    ["FIR_F15C",1250,1250,450],                                         // F-15C Eagle
    ["FIR_F15D",1250,1250,450],                                         // F-15D Eagle
    ["FIR_F15E",1250,1500,450],                                         // F-15E Strike Eagle
    ["vvar_rhino_e",1500,1750,450],                                     // F/A-18 E Super Hornet
    ["vvar_rhino_f",1500,1750,450],                                     // F/A-18 F Super Hornet
    ...
    ["condor_infantry_vvar",750,0,500],                                 // V-44 X Blackfish (Vehicle)
    ["condor_vehicle_vvar",750,0,500]                                 // V-44 X Blackfish (Vehicle)
];
